...
void manualbuilderinit() {
	...
	lv_label_set_text(addmodule, "+");
	lv_label_set_text(delmodule, "-");
	...
	lv_obj_set_style_text_font(addmodule, &lv_font_montserrat_42, LV_PART_MAIN);
	lv_obj_set_style_text_font(delmodule, &lv_font_montserrat_42, LV_PART_MAIN);
